...
import knn_eval
import linear_eval
import models.mocov2
import models.simclr
import vcl.vcl
import models.swav
import models.tico
import models.vicreg
...
METHODS = {
    "barlowtwins": {
        "model": models.barlowtwins.BarlowTwins,
        "transform": models.barlowtwins.transform,
    },
    "byol": {"model": models.byol.BYOL, "transform": models.byol.transform},
    "dcl": {"model": models.dcl.DCL, "transform": models.dcl.transform},
    "dclw": {"model": models.dclw.DCLW, "transform": models.dclw.transform},
    "dino": {"model": models.dino.DINO, "transform": models.dino.transform},
    "mocov2": {"model": models.mocov2.MoCoV2, "transform": models.mocov2.transform},
    "simclr": {"model": models.simclr.SimCLR, "transform": models.simclr.transform},
    "vcl": {"model": vcl.vcl.VCL, "transform": models.simclr.transform},    
    "swav": {"model": models.swav.SwAV, "transform": models.swav.transform},
    "tico": {"model": models.tico.TiCo, "transform": models.tico.transform},
    "vicreg": {"model": models.vicreg.VICReg, "transform": models.vicreg.transform},
}
...
def main(
    ...
    for method in method_names:
        ...
        model = METHODS[method]["model"](
            batch_size_per_device=batch_size_per_device, num_classes=num_classes , temperature=temperature
        )
